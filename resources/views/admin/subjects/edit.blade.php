        ...
        <form action="{{ route('admin.subjects.update', $subject->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="references_text" id="references_text" rows="6" class="w-full px-4 py-2.5 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-150 ease-in-out">{{ old('references_text', $referencesText ?? '') }}</textarea>

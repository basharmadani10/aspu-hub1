{{--
    ...
    Description: This is the main admin layout. The sidebar navigation has been centralized here
    to be consistent across all admin pages. It now includes all necessary links
    and logic to highlight the currently active page.
--}}
<!DOCTYPE html>
    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <aside class="flex flex-col w-64 bg-white shadow-lg">
            ...
            <nav class="flex-grow p-4 space-y-2">
                {{-- active_class() function is now loaded globally via app/Helpers/GeneralHelper.php --}}

                <a href="{{ route('admin.dashboard') }}" class="{{ active_class('admin.dashboard') }}">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    Dashboard
                </a>

                <a href="{{ route('admin.communities.index') }}" class="{{ active_class('admin.communities.*') }}">
                ...
                <a href="{{ route('admin.tags.index') }}" class="{{ active_class(['admin.tags.*']) }}">
                ...
                <a href="{{ route('admin.docs.index') }}" class="{{ active_class(['admin.docs.*']) }}">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    Manage Lectures
                </a>
